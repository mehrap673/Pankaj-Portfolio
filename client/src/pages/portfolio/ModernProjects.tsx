  ...
  const projects: Project[] = [
    {
      ...
      longDescription:
        "A complete e-commerce platform built with React, Node.js, and PostgreSQL. Features include user authentication, payment processing with Stripe, inventory management, real-time notifications, and a comprehensive admin dashboard. The platform handles thousands of transactions daily with 99.9% uptime.",
    ...
    },
    {
      ...
      longDescription:
        "An intelligent analytics dashboard that uses machine learning to provide actionable insights from business data. Built with React and Python, featuring real-time data visualization, predictive analytics, and automated reporting. Helps businesses increase efficiency by 40%.",
    ...
    },
    {
      ...
      longDescription:
        "A modern social media application with real-time messaging, story features, and advanced privacy controls. Built using React Native and Node.js with WebSocket technology for instant updates. Supports multimedia sharing, group chats, and algorithmic feed curation.",
